...
\begin{frame}{\Bioconductor{}: 1295 packages}
  \begin{columns}
    ...
    \item
      Workflows\footnote[frame]{\url{http://bioconductor.org/help/workflows}}
...
\begin{frame}{RNA-seq}
  \centering\includegraphics[width=.7\textwidth]{rna4.jpg}
...
\begin{frame}{Acknowledgments}
  Core team (current \& recent): Yubo Cheng, Valerie Obenchain,Herve
  Pages, Marcel Ramos, Lori Shepherd, Dan Tenenbaum, Greg Wargula.
  \medskip\par
